        ...
        <div className="contact-grid">
          ...
          <div className="contact-info-col">
            ...
            <p className="contact-text">
              Looking for a dedicated MERN Stack Developer, Software Engineer, or Full-Stack Project Collaborator? Feel free to reach out directly via email, phone, or send a message below!
            </p>
            ...
            <div className="contact-methods">
              <div className="contact-item">
                ...
                <div>
                  ...
                  <a href="mailto:indusingh7746@gmail.com" className="item-val">indusingh7746@gmail.com</a>
                </div>
              </div>
            ...
            <div className="form-card">
              {submitted ? (
                <div className="form-success">
                  ...
                  <p>Thank you for reaching out, Indu Singh will get back to you shortly.</p>
                </div>
              ) : (
